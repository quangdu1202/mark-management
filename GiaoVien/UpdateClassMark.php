...
<div id="fileUploadPopup" class="popup">
    <div class="popup-content">
        ...
        <form action="" method="post" style="text-align: center" enctype="multipart/form-data">
            <input type="file" name="uploadedFile" accept=".csv" value="import" style="display: block; width: 210px; margin: 10px auto">
    ...
    <div class="hover-menu">
        <div class="sub-menu" id="sub-menu">
            <form action="">
                ...
                if ($TrangThai == 1)
                    echo '
                    <button name="lockEdit" id="lockEdit" onclick="openPopup(event)">Khoá sửa điểm<i style="margin-left: 7px" class="fas fa-lock"></i></button>
                    <button name="uploadFile" id="uploadFile" onclick="openUploadFile(event)">Tải lên file điểm<i style="margin-left: 7px" class="fas fa-upload"></i></button>
                ';
                ?>
            </form>
            <form action="downloadFile.php" method="post">
                <button type="submit" name="downloadFile" id="downloadFile">Tải về file điểm<i style="margin-left: 7px" class="fas fa-download"></i></button>
            </form>
            <button onclick="showChart()">Biều đồ điểm<i class="fas fa-chart-bar" style="margin-left: 7px"></i></button>
        </div>
        <button id="main-button"><i class="fas fa-bars"></i></button>
    </div>
</div>
